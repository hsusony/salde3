...
class _CustomersScreenState extends State<CustomersScreen> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      // Row 7: Max Credit & Percent After Limit
                      Row(
                        children: [
                          Expanded(
                            child: _buildEnhancedTextField(
                      ...
                      // Row 6: Linked Account & Distributor
                      Row(
                        children: [
                          Expanded(
                            child: _buildEnhancedDropdownWithAdd(
                              label: 'ربط حسابات أخرى',
                              icon: Icons.link_rounded,
                              iconColor: const Color(0xFF8B5CF6),
                              value: _linkedAccount,
                              items: _linkedAccountsList,
                              onChanged: (value) => setState(() => _linkedAccount = value!),
                              onAdd: _showAddLinkedAccountDialog,
                              isDark: isDark,
                            ),
                          ),
                          const SizedBox(width: 16),
                          Expanded(
                            child: _buildEnhancedDropdownWithAdd(
                              ...
                              items: _distributorsList,
                              onChanged: (value) => setState(() => _distributorLink = value!),
                              onAdd: _showAddDistributorDialog,
                              isDark: isDark,
                            ),
                          ),
                        ],
                      ...
                      // Row 8: Price Link & Reference Number  
                      Row(
                        children: [
                          Expanded(
                            child: Column(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            // Checkbox 1: حسابات تاريخ محددة
                            Container(
                              decoration: BoxDecoration(
                                color: _isSpecificDate
                          ...
                          children: [
                            Expanded(
                              child: _buildMainActionButton(
                                label: _isEditing ? 'تحديث الحساب' : 'حفظ الحساب',
                                icon: _isEditing
  ...
  Widget _buildEnhancedDropdownWithAdd({
    required String label,
    required IconData icon,
  ...
  // Helper Widgets للتصميم المحسّن
