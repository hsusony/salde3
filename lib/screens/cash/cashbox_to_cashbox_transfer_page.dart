...
class CashboxToCashboxTransferPage extends StatefulWidget {
  const CashboxToCashboxTransferPage({super.key});

  @override
  State<CashboxToCashboxTransferPage> createState() =>
      _CashboxToCashboxTransferPageState();
}

class _CashboxToCashboxTransferPageState
    extends State<CashboxToCashboxTransferPage> {
  final _formKey = GlobalKey<FormState>();
  final _voucherNumberController = TextEditingController(text: '1');
  final _sourceCashboxBalanceController = TextEditingController(text: '0');
  final _destinationCashboxBalanceController = TextEditingController(text: '0');
  ...
  void dispose() {
    ...
    _sourceCashboxBalanceController.dispose();
    _destinationCashboxBalanceController.dispose();
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: Center(
                                        child: Text(
                                          _sourceCashboxBalanceController.text,
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: Center(
                                        child: Text(
                                          _destinationCashboxBalanceController
                                              .text,
                                          style: const TextStyle(
                                            color: Colors.white,
                                            fontSize: 16,
