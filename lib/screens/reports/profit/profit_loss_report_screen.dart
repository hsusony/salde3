        ...
        children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'قائمة الأرباح والخسائر الشاملة',
                            style: TextStyle(
                              fontSize: 14,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                _buildBottomCard('المجموع', '0', const Color(0xFF3B82F6)),
                const SizedBox(width: 24),
                _buildBottomCard(
                    'وصاف العروض المبالغ', '0', const Color(0xFF10B981)),
                const SizedBox(width: 24),
                _buildBottomCard('رصيد العمولات', '0', const Color(0xFFEF4444)),
              ],
            ),
          ),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        _buildTableHeader('وصاف العروض المبالغ', flex: 2),
                        _buildTableHeader('رصيد العمولات', flex: 1),
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'لا توجد سجلات أرباح وخسائر في الفترة المحددة',
                            style: TextStyle(
                              fontSize: 14,
