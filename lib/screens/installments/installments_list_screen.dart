...
class _InstallmentsListScreenState extends State<InstallmentsListScreen> {
                  ...
                  children: [
                    ...
                    PopupMenuButton<String>(
                      ...
                      itemBuilder: (context) => [
                        ...
                        const PopupMenuItem(
                            value: 'active', child: Text('النشطة')),
                        const PopupMenuItem(
                            value: 'completed', child: Text('المكتملة')),
                        const PopupMenuItem(
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildInstallmentCard(
                        installment, currencyFormat, isDark);
                  },
                );
              },
            ),
  ...
  Widget _buildInstallmentCard(
      Installment installment, NumberFormat currencyFormat, bool isDark) {
    Color statusColor;
    String statusText;
    IconData statusIcon;
                      ...
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          actions: [
                            ...
                            ElevatedButton(
                              onPressed: () {
                                Provider.of<InstallmentsProvider>(context,
                                        listen: false)
